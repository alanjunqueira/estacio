...
public class Equipe extends Thread {
  ...
  private boolean empacotar(int nr_produtos) {
    Thread thd;
    int thd_criadas = pool_produtos.retirarProdutos(nr_produtos); // O número de threads a ser criado para empacotar é
                                                                  // igual ao número de produtos retirados pela equipe.
    boolean controle;
